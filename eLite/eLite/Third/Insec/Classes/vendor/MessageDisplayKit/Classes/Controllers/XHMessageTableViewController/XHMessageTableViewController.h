 ...
 *  @param date   发送时间
 */
- (void)disSendVistingCard:(UIImage*)card withInfo:(NSDictionary*)dic fromSender:(NSString *)sender onDate:(NSDate *)date;
/**
 *  发送文本消息的回调方法
 *
 *  @param text   目标文本字符串
