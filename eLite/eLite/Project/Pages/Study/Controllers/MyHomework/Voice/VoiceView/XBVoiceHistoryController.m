...
@interface XBVoiceHistoryController ()<
...
@implementation XBVoiceHistoryController
...
- (void)__init {
    ...
    for (int i = 0; i < _subjects.count; i ++) {
        XBVoiceHistoryContentController *vc = [XBVoiceHistoryContentController new];
