//
//  XBHistoryDetailContentViewController.m
//  
//
...
#import "XBHistoryDetailCell.h"

@interface XBHistoryDetailContentViewController ()<
UITableViewDelegate,
...
@implementation XBHistoryDetailContentViewController
...
{
    XBHistoryDetailCell *cell = [[XBHistoryDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.subject = _infoModel.option[indexPath.row];
    
    if ([cell.subject isEqualToString:_infoModel.answer]) {
