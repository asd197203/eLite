...
inline void Run_TakeTime (dispatch_block_t block, NSString *message) {
    ...
    FLOG(@"Took [%f] seconds to [%@]", (CGFloat)nanos / NSEC_PER_SEC, message);
}