...
typedef int(^CXZExecuteStatementsBlock)(NSDictionary *resultsDictionary);

@interface CXZDataBase : NSObject
...
@interface CXZStatement : NSObject
...
@interface CXZResultSet : NSObject

@property (strong) NSString *query; //!< 缓存sqlite的key
@property (strong) CXZStatement *myStatement; //!< sqlite语句
